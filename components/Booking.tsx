...
export default function Booking() {
  ...
  return (
    <div className="h-full min-h-screen flex flex-col justify-center items-center bg-white">
      ...
      <div className="h-16 w-48 bg-white -mt-16 z-50">
      ...
      <div className="text-center text-sm text-gray-500 mt-4">
        ...
        <p>You will receive a recording of your session, so you can revisit it anytime and continue uncovering insights</p>
      </div>
    </div>
  );
};
