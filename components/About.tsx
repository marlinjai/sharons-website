...
const About = () => {
  return (
    <section id="about" className="h-screen flex flex-col-reverse md:flex-row items-center justify-center gap-24 px-6 py-16 md:py-24 bg-white">
      <div className="text-left flex flex-col items-start md:text-left max-w-md">
        <h4 className="text-3xl md:text-4xl leading-4 font-secondary" style={{ color: '#A32015' }}>Hello,</h4><br />
