          ...
          <Accordion>
            <AccordionItem title="Menu">
              <ul className="space-y-3">
                <li><a href="/#the-session" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary block">Sessions</a></li>
                <li><a href="/#about" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary block">About</a></li>
                <li><a href="/#reviews" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary block">Reviews</a></li>
                <li><a href="/#contact" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary block">Contact</a></li>
              </ul>
            </AccordionItem>
            ...
            <AccordionItem title="Resources">
              <ul className="space-y-3">
                <li><Link href="/blog" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary block">Blog</Link></li>
                <li><Link href="/#faq" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary block">FAQ</Link></li>
              </ul>
            </AccordionItem>
          </Accordion>
        </div>
