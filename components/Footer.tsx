      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href={homeLink} className="inline-block group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="font-secondary text-3xl font-semibold text-gray-900 group-hover:text-[#944923] transition-colors duration-200">
                  ReTurn
                </div>
              </div>
            </Link>
            <p className="text-gray-600 mb-6 max-w-md font-primary leading-relaxed">
              Regression Hypnosis: the Adventure of a Lifetime for the Curious, the Bold, and the Ready.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/privacy" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 font-primary">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
