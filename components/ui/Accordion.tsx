...
export function AccordionItem({ title, children, defaultOpen = false }: AccordionItemProps) {
  ...
  return (
    <div className="border-b border-gray-200 last:border-b-0">
      ...
      >
        <h3 className="font-secondary font-semibold text-gray-900 text-lg">{title}</h3>
        <motion.div animate={{ rotate: isOpen ? 180 : 0 }} transition={{ duration: 0.2 }} className="text-gray-600">
