    ...
    <section id="faq" className="w-full py-32 px-4 flex flex-col items-center bg-white">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-primary text-xl text-gray-600">
            Common questions about Regression Hypnosis sessions
          </p>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="border border-gray-200 rounded-2xl overflow-hidden">
              ...
              >
                <h3 className="font-secondary text-lg font-semibold text-gray-900 pr-4">
                  {faq.question}
                </h3>
              ...
              {openIndex === index && (
                <div className="px-8 pb-6">
                  <div className="border-t border-gray-100 pt-6">
                    <p className="font-primary text-gray-700 leading-relaxed">
                      {faq.answer}
                    </p>
                  </div>
                </div>
        ...
        <div className="text-center mt-16">
          <p className="font-primary text-lg text-gray-600 mb-6">
