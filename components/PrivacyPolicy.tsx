...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      ...
      {/* Modal Overlay */}
      {isOpen && (
        <div className={`fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 ${isClosing ? 'animate-fadeOut' : 'animate-fadeIn'}`}>
          <div className={`bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto ${isClosing ? 'animate-slideOut' : 'animate-slideIn'}`}>
            {/* Modal Header */}
            <div className="flex justify-between items-center p-6 border-b border-gray-200">
              <h2 className="text-2xl font-secondary font-semibold text-gray-900">
                Privacy Policy
              </h2>
              <button
                onClick={closeModal}
            ...
            <div className="p-6 space-y-6 font-primary text-gray-700 leading-relaxed">
              <div>
                ...
                <p className="mb-4">
                  Sharon Di Salvo<br />
                  Sole proprietor<br />
                  Praxis am Zionskirchplatz<br />
                  10-11, 10117 Berlin<br />
                  Germany<br />
              ...
              <div>
                ...
                <p className="mb-4">
                  We may share limited data with third-party service providers who assist us in:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4">
                  These providers process data solely on our behalf and under data processing agreements in compliance with the GDPR.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  or as required by tax, legal, or regulatory obligations. Session-related information is kept for 
                  up to 10 years unless deletion is requested earlier, subject to legal requirements.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Some of our service providers are located outside the EU (e.g., in the USA). In such cases, 
                  we ensure appropriate safeguards are in place under GDPR, such as Standard Contractual Clauses.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mb-4">
                  If you believe your data protection rights have been violated, you may lodge a complaint with your local supervisory authority. In Germany, this is the:
                </p>
                <p>
                  Berliner Beauftragte für Datenschutz und Informationsfreiheit<br />
                  <a href="https://www.datenschutz-berlin.de" className="text-[#C5441E] hover:text-[rgb(245,124,0)] underline" target="_blank" rel="noopener noreferrer">
              ...
              <div>
                ...
                <p>
                  We do not use cookies or third-party tracking tools on this website.
                </p>
              </div>
