...
export default function ReviewsII() {
  ...
  const leftReviews = [
    {
      title: 'The hypnosis sessions are a source of harmony and positive emotions!',
      content:
        "The [Studio Name] hypnosis studio is a source of harmony and positive emotions! I've been attending sessions for a year and a half now, and the results are astonishing. The therapists are fantastic at what they do and always help find the right level of relaxation. I've found not only mental healing but also friends among like-minded individuals. Thanks to the therapists, I've become more flexible and calm.",
      name: 'John Smith',
      age: 26,
      rating: 5,
    },
  ...
  const centerReviews = [
    {
      title: "I've found my sanctuary at this hypnosis studio.",
      content:
        "I've found my sanctuary at this hypnosis studio. The therapists are incredibly knowledgeable and create a welcoming atmosphere that makes each session a rejuvenating experience.",
      name: 'Sophia Brown',
      age: 20,
      rating: 5,
    },
    {
      title: 'This hypnosis studio is a hidden gem!',
      content:
        "This hypnosis studio is a hidden gem! The variety of techniques suits all levels, and the peaceful ambiance instantly puts you in a zen state of mind. The therapists are fantastic at what they do and always help find the right level of challenge. I've found not only mental healing but also friends among like-minded individuals. Thanks to the therapists, I've become more flexible and calm.",
      name: 'Daniel Wilson',
      age: 31,
      rating: 5,
    },
  ...
  const rightReviews = [
    {
      title: 'The hypnosis studio offers a perfect blend.',
      content:
        'The hypnosis studio offers a perfect blend of traditional and modern healing practices. The serene setting and expert guidance make it an ideal place to escape the daily hustle and find inner balance.',
      name: 'Emma Taylor',
      age: 22,
      rating: 5,
    },
    {
      title: 'Attending sessions at this hypnosis studio has truly transformed my life.',
      content:
        "Attending sessions at this hypnosis studio has truly transformed my life. The skilled therapists encourage personal growth, and I leave each session feeling stronger, both mentally and emotionally. I cannot express how grateful I am for this hypnosis studio. The therapists' dedication to their craft is evident in every session, and the sense of harmony and mindfulness they cultivate is truly exceptional.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center -mb-32">
          <h2 className="font-serif text-5xl md:text-6xl font-normal text-gray-900 mb-6">
            Celebrating hypnosis <em className="italic">success.</em>
          </h2>
