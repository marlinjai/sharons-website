      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Each instructor is certified in their respective yoga discipline and is dedicated to guiding you on your journey
          </p>
        </div>
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              {schedule[selectedDay as keyof typeof schedule]?.map((item, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gradient-to-r from-yoga-sand to-white rounded-lg">
                  <div className="flex items-center space-x-4">
                    <div className="text-yoga-earth font-semibold">
                      {item.time}
                    </div>
                    <div>
