        ...
        <Container style={container}>
            ...
            <Section style={featuredSection}>
              <div style={featuredBox}>
                ...
                {featuredStory.imageUrl && (
                  <img src={featuredStory.imageUrl} alt={featuredStory.title} style={featuredImage} />
                )}
          ...
          {sections && sections.length > 0 ? (
            ...
            <Section style={defaultSection}>
              <Heading style={sectionHeading}>Welcome to Your First Newsletter</Heading>
              <Text style={paragraph}>
                This is a preview of your newsletter template. When you create an actual newsletter, you'll add content
                sections here that will be dynamically rendered.
              </Text>
              <Text style={paragraph}>
                Each newsletter can include text sections, quotes, stories, tips, call-to-actions, and images - all
                styled beautifully to match your brand.
              </Text>
            </Section>
          )}
            ...
            {Object.keys(socialLinks).length > 0 && (
              <div style={socialLinksContainer}>
                ...
                {socialLinks.linkedin && (
                  <Link href={socialLinks.linkedin} style={socialLink}>
                    LinkedIn
                  </Link>
                )}
              </div>
    ...
    case 'quote':
      return (
        <div style={quoteBox}>
          ...
          {section.author && <Text style={quoteAuthor}>— {section.author}</Text>}
        </div>
      );
    ...
    case 'story':
      return (
        <>
          {section.title && <Heading style={sectionHeading}>{section.title}</Heading>}
          {section.imageUrl && (
            <img src={section.imageUrl} alt={section.imageAlt || section.title || 'Story image'} style={storyImage} />
          )}
          <Text style={paragraph}>{section.content}</Text>
        </>
      );
